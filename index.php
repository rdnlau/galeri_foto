...
<title>Website Galeri Foto Anime</title>
...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="index.php">GALERI FOTO ANIME</a></h1>
        <ul>
    ...
    <div class="container">
       ...
       <div class="box">
          <?php
              $foto = mysqli_query($conn, "SELECT * FROM tb_image WHERE image_status = 1 ORDER BY image_id DESC LIMIT 50");
    ...
    <!-- footer -->
     <footer>
        <div class="container">
            <small>R. Karisha Laura Sabila | XII PPLG 1 2024 - Website Galeri Foto Anime.</small>
        </div>
    </footer>
</body>
</html>